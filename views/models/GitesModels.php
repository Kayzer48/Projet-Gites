...
<?php
    ...
    public function searchGite(){
        $db=$this->connectPDO();
        $search=$_POST['search'];
        $req=$db->prepare("SELECT * FROM `gites` WHERE nom_gite= '$search'");
        $req->execute();
        $products = $req->fetchAll(PDO::FETCH_ASSOC);
        //var_dump($req);
        ?>
        ...
        <div class="container mt-5 col-lg-6">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control"  id="description_gite" name="description_gite" rows="3" placeholder=""><?= $row['description_gite'] ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="<?= $row['zone_geo'] ?>" class="form-control" id="zone_geo" name="zone_geo" placeholder=""/>
                </div>
